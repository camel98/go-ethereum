...
func (b *Block) BlockHash() common.Hash   { return b.blockHash }
...
func (b *Block) WithBodyAndHash(transactions []*Transaction, uncles []*Header, blockHash common.Hash) *Block {
	body := b.WithBody(transactions, uncles)
